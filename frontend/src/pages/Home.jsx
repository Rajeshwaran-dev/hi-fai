                ...
                return (
                  ...
                  >
                    <div className="flex min-w-0 flex-col gap-2.5 sm:flex-row sm:items-center sm:gap-2.5 sm:overflow-hidden md:gap-3">
                      <div className={`mr-1 inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-white/10 shadow-[inset_0_1px_0_rgba(255,255,255,0.15)] sm:h-9 sm:w-9 md:h-10 md:w-10 ${a.iconWrap}`}>
                        <item.Icon className="h-4 w-4 md:h-5 md:w-5" strokeWidth={2} />
                      </div>
                      <span
